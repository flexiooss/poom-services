...
public class ETaggedRead<Request extends ETaggedReadRequest, Response> implements Function<Request, Response> {
    ...
    public ETaggedRead(Repository<Etag, PropertyQuery> etagRepository, String defaultCacheControl, Function<Request, Response> taggedHandler, Class<? extends Response> responseType) {
