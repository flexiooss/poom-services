...
public class BridgedAdapter<EntityTpe, CreationType, ReplaceType, UpdateType> implements PagedCollectionAdapter<ObjectValue, ObjectValue, ObjectValue, ObjectValue> {
    ...
    private final PagedCollectionAdapter<EntityTpe, CreationType, ReplaceType, UpdateType> deleguate;
    ...
    public BridgedAdapter(
            PagedCollectionAdapter<EntityTpe, CreationType, ReplaceType, UpdateType> deleguate,
